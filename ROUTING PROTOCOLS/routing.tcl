...
$ns attach-agent $n(0) $udp1 set null [new Agent/Null]
$ns attach-agent $n(5) $null
$ns connect $udp1 $null
$udp1 set fid_ 1
set udp2 [new Agent/UDP]
$ns attach-agent $n(1) $udp2 set null [new Agent/Null]
$ns attach-agent $n(5) $null
...
$ns at 4.5 "$ns detach-agent $n(0) $udp1 ; $ns detach-agent $n(5) $null ; $ns
detach-agent
$n(1) $udp2"
$ns at 5.0 "finish"
$ns run